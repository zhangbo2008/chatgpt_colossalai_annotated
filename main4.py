...
from datasets import load_dataset  #pip 一下datasets
...
def train(args):
    ...
    with strategy.model_init_context():
        # model = BLOOMRM(pretrained=args.pretrain).cpu()
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--dataset', type=str, default='data_my/rm-static/data')
    ...
    args.pretrain='bigscience/bloom-560m'
    # args.pretrain='gpt2'
    train(args)
